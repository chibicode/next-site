...
Here, we are going to use the [Dynamic Routing](https://nextjs.org/docs/routing/dynamic-routes) feature of Next.js, it allows you to handle dynamic routes in `/pages`.
